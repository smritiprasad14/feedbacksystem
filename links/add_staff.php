...
<h2>Enter details of teacher</h2>
<table>
<tr>
<td class="inp"> Teacher Name</td>
...
<tr>
<td class="inp"> Teacher DOB</td>
<td> <input type="text" name="dob" class="inp">
</tr>
<tr>
<td class="inp">  Department</td>
...
$c=$_POST['cla'];
$d=$_POST['dob'];
$q=mysql_query("INSERT into teacher(`id`, `name`, `department` ) VALUES ('$a','$b', '$c')");
$qr=mysql_query("INSERT INTO teacher_login (`id` ,`password`)VALUES ('$a', '$d')");
